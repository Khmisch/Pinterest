...
class MessagesUpdatesAdapter(var context: Context) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        val view =
            LayoutInflater.from(parent.context).inflate(R.layout.item_message_updates_view, parent, false)
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
            ...
            val updateTime = photoItem.updated_at
            ...
            if (holder is PinsViewHolder) {
                ...
                holder.tv_time.text = updateTime
