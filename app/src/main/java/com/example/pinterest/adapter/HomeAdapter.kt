...
class HomeAdapter  (var context: HomeFragment, var items: ArrayList<Photo>) : RecyclerView.Adapter<RecyclerView.ViewHolder>(){
...
//                    .into(holder.iv_pin);
                ...
                holder.iv_pin.setOnClickListener {
                    context.callDetailsActivity(photoItem)
                }
            }
    }
